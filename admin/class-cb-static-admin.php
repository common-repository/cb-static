...
class cb_static_admin {
    ...
    public function plugin_row_meta( $meta, $file ) {
        ...
        if( $file == $plugin ) {
            $meta[] = '<a href="https://wordpress.org/support/plugin/cb-static" target="_blank">' . __('Plugin support', $this->plugin_domain) . '</a>';
            $meta[] = '<a href="https://wordpress.org/support/view/plugin-reviews/cb-static" target="_blank">' . __('Rate plugin', $this->plugin_domain) . '</a>';
