...
class cb_static {
    ...
    private function load_dependencies() {
	    ...
	    require_once plugin_dir_path(dirname(__FILE__)) . "public/class-cb-static-public.php";
	...
	private function define_public_hooks() {
		...
		$public = new cb_static_public( $this->get_plugin_name(), $this->get_plugin_domain(), $this->get_plugin_version(), $this->get_loader(), $this->get_meta_key() );
